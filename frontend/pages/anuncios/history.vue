...
<template>
  <div class="h-svh flex overflow-hidden bg-white text-neutral-900 font-sans print:bg-white print:p-0">
    ...
    <div class="flex-1 flex flex-col min-w-0 min-h-0">
      ...
      <div class="flex-none px-6 sm:px-10 pt-8 sm:pt-12 pb-6 border-b border-neutral-50 print:hidden z-10 space-y-3">
        ...
        <div class="flex items-center gap-3">
          ...
          <button
            ...
            class="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest border px-4 py-2 rounded-full transition-all active:scale-95"
            :class="showLyrics ? 'bg-amber-50 text-amber-600 border-amber-200 hover:bg-amber-100' : 'text-neutral-400 border-neutral-200 hover:bg-neutral-50 hover:text-neutral-900'"
          >
            <Icon :name="showLyrics ? 'tabler:music' : 'tabler:music-off'" class="size-4" />
            <span class="hidden sm:inline">Letra</span>
          </button>
          <button
            @click="generatePdf"
      ...
      <div class="lg:hidden flex-1 overflow-y-auto px-4 py-4 pb-24 print:hidden relative">
        <!-- Mobile Active Lyrics -->
        <Transition
            enter-active-class="transition duration-500 ease-out"
            enter-from-class="opacity-0 -translate-y-2"
            enter-to-class="opacity-100 translate-y-0"
